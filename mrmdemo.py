...
with tab2:
    ...
    with col6:
        ...
        st.write("**GBP**")
        lending_ccy_gbp_2_adj_rate = st.number_input("GBP 2 years", value = 0.0209, format = "%f")
        lending_ccy_gbp_5_adj_rate = st.number_input("GBP 5 years", value = 0.0216, format = "%f")
        st.write("**HKD**")
        lending_ccy_hkd_2_adj_rate = st.number_input("HKD 2 years", value = 0.0296, format = "%f")
        lending_ccy_hkd_5_adj_rate = st.number_input("HKD 5 years", value = 0.031, format = "%f")
        st.write("**USD**")
        lending_ccy_usd_2_adj_rate = st.number_input("USD 2 years", value = 0.0314, format = "%f")
        lending_ccy_usd_5_adj_rate = st.number_input("USD 5 years", value = 0.0332, format = "%f")
        st.write("**AUD**")
        lending_ccy_aud_2_adj_rate = st.number_input("AUD 2 years", value = 0.0324, format = "%f")
        lending_ccy_aud_5_adj_rate = st.number_input("AUD 5 years", value = 0.038, format = "%f")
        st.write("**JPY**")
        lending_ccy_jpy_2_adj_rate = st.number_input("JPY 2 years", value = -0.0007, format = "%f")
        lending_ccy_jpy_5_adj_rate = st.number_input("JPY 5 years", value = 0.0004, format = "%f")
...
st.sidebar.header("Personal Assets and Liabilities:")
...
st.sidebar.header("Real Estate Asset and Liabilities:")
...
with tab1:
    ...
    with col1:
        ...
        proposed_annual_rent = st.number_input("Proposed Annual Rent", value = 500000, format = "%d")
    ...
    with col3:
        if len(resultpairs) == 0:
            ...
            st.pyplot(fig)
    with col4:
        st.table(resultpairs[["LVR", "InterestRate"]])
